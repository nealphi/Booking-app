...
const GuestInfoForm = ({ hotelId, pricePerNight }: Props) => {
  ...
  const onSingInClick = (data: GuestInfoFormData) => {
    ...
    navigate("/sign-in", { state: { from: location } }); //the second argument is for pushing back the user to the previous url after signIn
  };
